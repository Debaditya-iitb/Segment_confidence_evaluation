...
DEFAULT = os.path.join(HERE, "models", "miscue_clf_EN_foldavg_ed_conf2.joblib")
...
def main():
    ...
    ap.add_argument("--model", default=DEFAULT, help="model .joblib (default: EN kvg345 ed_conf2)")
    ...
    if a.slim:
        keep = [c for c in ("utterance_id", "canonical_word", "start_time", "end_time",
                            "GT_label", "Cano_label", "costed_neglog", "entropy_gibbs_exp_min",
